TestCase('updated status view', {
    ...
    setUp: function() {
        ...
        status_view = hello_world.views.status_display;

        status_view.status_element = $(this.status_dom).find('h1');
    },
    ...
    'test that h1 tag has status appended': function() {
        ...
        assertEquals('Hello world', status_view.status_element.html());
    }
